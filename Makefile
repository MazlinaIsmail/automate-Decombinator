...
DID_ALPHA = $(filter $(wildcard DualIndexDemultiplexed/*alpha*.gz),$(wildcard DualIndexDemultiplexed/*.gz))
DID_BETA = $(filter $(wildcard DualIndexDemultiplexed/*beta*.gz),$(wildcard DualIndexDemultiplexed/*.gz))
